        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="w-full grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
                ...
                <div class="flex flex-col gap-y-5">
                    ...
                    <Link href="{{ $link['link'] }}" class="border rounded-md px-4 py-2 bg-white shadow-md shadow-primary-200 hover:shadow-xl hover:shadow-primary-300 flex flex-col gap-y-2">
