<SpladeConfirm default-title="{{ __('Estas seguro que deseas continuar?') }}" default-text=""
    default-password-text="{{ __('Por favor confirma tu contraseña para poder continuar') }}"
    default-confirm-button="{{ __('Confirmar') }}" default-cancel-button="{{ __('Cancelar') }}"
                            ...
                            <x-splade-component is="dialog" panel
                                    ...
                                    <div class="text-center sm:mt-0 sm:text-left">
                                        ...
                                        <div class="mt-2 flex rounded-md border border-gray-300 shadow-sm"
                                            ...
                                            <input type="password" name="password" placeholder="{{__('Contraseña')}}"
                                                ...
                                                class="rounded-md block w-full border-0 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed"
                                ...
                                <div class="mt-5 sm:mt-4 sm:flex">
                                    <button dusk="splade-confirm-confirm" type="button"
                                        ...
                                        :class="{
                                            'bg-primary-500 hover:bg-primary-800 focus:ring-primary-500': !confirm.confirmDanger,
                                    ...
                                    <button dusk="splade-confirm-cancel" type="button"
                                        class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 px-4 py-2 bg-white text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
