    ...
    <tr :class="{
        ...
        <td width="64" class="text-xs px-6 py-4">
            ...
            <input @change="(e) => table.setSelectedItem(@js($itemPrimaryKey), e.target.checked)"
                ...
                class="rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 disabled:opacity-50 checked:bg-primary-800 checked:hover:bg-primary-800 checked:focus:bg-primary-800"
        ...
        <td @if($table->rowLinks->has($itemKey))
            ...
            @if($column->highlight) text-gray-900 font-medium @else text-gray-500 @endif
