<Link slideover href="{{ route('profesors.edit', $profesor->id) }}" class=" bg-primary-800 text-white px-4 py-2 rounded-md">
    {{__('Editar')}}
</Link>
...
<x-splade-form
    require-password 
    method="delete"
    :confirm="__('Estas seguro que deseas eliminar esta cuenta?')"
